        ...
        <div className="max-w-7xl mx-auto space-y-12 md:space-y-0 lg:grid lg:grid-cols-4 lg:gap-8">
          ...
          <div className="text-white space-y-4">
            ...
            <div className="flex space-x-5 items-center">
              ...
              >
                <FaFacebook className="w-6 h-6 text-white hover:text-[var(--color-primary)] transition" />
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer">
                <FaTwitter className="w-6 h-6 text-white hover:text-[var(--color-primary)] transition" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <FaLinkedin className="w-6 h-6 text-white hover:text-[var(--color-primary)] transition" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <FaYoutube className="w-6 h-6 text-white hover:text-[var(--color-primary)] transition" />
              </a>
              <button
                onClick={() =>
              ...
              >
                <FaWhatsapp className="w-6 h-6 text-white hover:text-[var(--color-primary)] transition" />
              </button>
            </div>
          </div>
        </div>
